...
public class GeronimoJ2eePlatformFactory extends J2eePlatformFactory {
    ...
    private static final WeakHashMap<GeronimoDeploymentManager, GeronimoJ2eePlatformImpl> instanceCache =
            new WeakHashMap<GeronimoDeploymentManager, GeronimoJ2eePlatformImpl>() ;
    ...
    public synchronized J2eePlatformImpl getJ2eePlatformImpl(DeploymentManager dm)
    {
        ...
        {
            platformImpl = new GeronimoJ2eePlatformImpl(gdm) ;
            instanceCache.put(gdm, platformImpl) ;
        }
