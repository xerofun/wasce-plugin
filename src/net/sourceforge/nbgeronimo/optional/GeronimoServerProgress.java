 ...
 * @author John Platts
 */
class GeronimoServerProgress implements ProgressObject {
    private Object source ;
    private List<ProgressListener> listeners ;
    private DeploymentStatus deploymentStatus ;
    
    public GeronimoServerProgress(Object source) {
        this.source = source ;
        listeners =
                Collections.synchronizedList(new LinkedList<ProgressListener>()) ;
    }
    ...
    public void stop() throws OperationUnsupportedException {
        throw new OperationUnsupportedException("The stop operation is unsupported.") ;
    }
    ...
    public void notify(DeploymentStatus deploymentStatus) {
        ...
        synchronized(this) {
            if(listeners != null) {
                targets = new ProgressListener[listeners.size()] ;
                targets = listeners.toArray(targets) ;
            }
        }
        ...
        if(targets != null)
        {
            ...
            {
                targets[i].handleProgressEvent(progressEvt);
            }
        }
    }
}
