 ...
 * @author John Platts
 */
public class GeronimoDeploymentConfiguration implements DeploymentConfiguration
{
    private GeronimoDeploymentManager dm ;
    private DeploymentConfiguration configuration ;
    private GeronimoClassLoader classLoader ;
    private DeployableObject deployableObject;
    
    public GeronimoDeploymentConfiguration(GeronimoDeploymentManager dm,
            DeploymentConfiguration configuration)
    {
        this.dm = dm ;
        this.configuration = configuration ;
        this.classLoader = GeronimoClassLoader.getInstance(dm.getServerRoot()) ;
        this.deployableObject = null;
    }

    public DeployableObject getDeployableObject() {
        if(deployableObject == null) {
            deployableObject = configuration.getDeployableObject();
        }
    ...
    public DConfigBeanRoot getDConfigBeanRoot(DDBeanRoot bean) throws ConfigurationException {
        ...
        try
        {
            return configuration.getDConfigBeanRoot(bean) ;
        }
        finally
        {
